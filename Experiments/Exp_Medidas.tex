...
\item Determine o volume de cada sólido observando o número de algarismos significativos.
\end{enumerate}
...
\begin{enumerate}
    \item Preencha a proveta com um volume de água suficiente para cobrir o corpo.
    \item Anote o valor inicial de volume na tabela correspondente.
    \item Submerja os corpos irregulares e anote as novas leituras de volume na tabela correspondente.
\end{enumerate}
...
\begin{enumerate}
     ...
     \item Determine a densidade de cada sólido observando o número de algarismos significativos. Para os sólidos regulares, utilize as medidas de volume obtidas através das medidas realizadas com o paquímetro.
\end{enumerate}
...
\begin{table*}[!htpb]
	...
	\begin{tabular}{cp{25mm}p{25mm}p{25mm}p{25mm}}
		\toprule
		Paralelepípedo & Altura & Largura & Comprimento & Volume  \\
		\midrule	
...
\begin{table*}[!htpb]
	...
	\begin{tabular}{cp{25mm}p{25mm}p{25mm}}
		\toprule
		Cilíndro & Diâmetro & Comprimento & Volume  \\
		\midrule
...
\begin{table*}[!htpb]
	...
	\begin{tabular}{cp{25mm}p{25mm}p{25mm}}
		\toprule
		{\centering Corpo} 				& Volume inicial & Volume final & Volume \\
		\midrule
		\cellcolor[gray]{0.89}1 & \cellcolor[gray]{0.92} & \cellcolor[gray]{0.89} & \cellcolor[gray]{0.92} \\
		\cellcolor[gray]{0.95}2 & \cellcolor[gray]{0.97} & \cellcolor[gray]{0.95} & \cellcolor[gray]{0.97} \\
		\bottomrule
...
\begin{table*}[!ht]
	...
	\begin{tabular}{cp{25mm}p{25mm}p{25mm}}
		\toprule
		{\centering Corpo} 				& Massa & Volume & Densidade \\
		\midrule
		\cellcolor[gray]{0.89}1 & \cellcolor[gray]{0.92} & \cellcolor[gray]{0.89} & \cellcolor[gray]{0.92} \\
		\cellcolor[gray]{0.95}2 & \cellcolor[gray]{0.97} & \cellcolor[gray]{0.95} & \cellcolor[gray]{0.97} \\
		\bottomrule
