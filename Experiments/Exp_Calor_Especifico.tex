...
\begin{equation}\label{Eq:ConservacaoDaEnergia2}
    \Delta E_S^{\textrm{mec}} + \Delta E_S^{\textrm{int}} = W_{F_{\textrm{ext}}} + Q + R. \mathnote{Princípio da conservação da energia (1\textordfeminine~Lei da Termodinâmica)}
\end{equation}
%
...
\begin{align}
    \Delta E^{\textrm{mec}} + \Delta E^{\textrm{int}} &= W_{\textrm{ext}} + Q \\
    \Delta E^{\textrm{int}} &= Q,
\end{align}
%
onde $\Delta E^{\textrm{mec}}$ é zero pois não há variação nem da energia cinética, nem de qualquer energia potencial. Além disso, não existe nenhum trabalho efetuado sobre o corpo, portanto $W_{\textrm{ext}}$ também é zero.
...
de onde obtemos
\begin{equation}
	C = -c\cdot\left[\frac{m_q(T^f - T_q)+m_f(T^f - T^i)}{(T^f - T^i)}\right].
\end{equation}
...
\begin{equation}
	c_a = - \left[\frac{(mc + C)\cdot(T^f - T^i)}{m_a (T^f - T_q)}\right]
\end{equation}
...
%%%%%%%%%%%%%%%%%%%%%
\begin{enumerate}
	\item Determine a massa $m^{\rm{Cal}}$ do calorímetro com o auxílio da balança, anote o resultado na Tabela~\ref{Tab:CapacidadeTermica};
	...
	\item Verifique a massa $m^{\rm{Cal}}_{\text{água fria}}$ do calorímetro com a água e anote na Tabela~\ref{Tab:CapacidadeTermica};
	...
	\item Verifique a massa final $m^{\rm{Cal}}_{\text{água fria+quente}}$ do sistema;
...
\begin{enumerate}
	\item Determine a massa $m^{\rm{Cal}}$ do calorímetro com o auxílio da balança, anote o resultado na Tabela~\ref{Tab:CalorEspecificoCorpo1};
	\item Adicione água fria ao calorímetro até que ela cubra aproximadamente um quarto da parte metálica interna;
	\item Verifique a massa $m^{\rm{Cal}}_{\text{água fria}}$ do calorímetro com a água fria e anote na Tabela~\ref{Tab:CalorEspecificoCorpo1};
	...
	\item Retire a amostra do calorímetro, seque-a e verifique sua massa $m^a$ com o auxílio da balança e a anote na Tabela~\ref{Tab:CalorEspecificoCorpo1}.
	\item Repita o procedimento acima mais duas vezes para a mesma amostra. Após finalizar os procedimentos para a amostra em questão, repita todo o procedimento para cada um dos materiais disponíveis (três vezes), anotando os resultados nas Tabelas~\ref{Tab:CalorEspecificoCorpo2} a~\ref{Tab:CalorEspecificoCorpo4}.
\end{enumerate}
...
\begin{question}[type={exam}]{1}
Identifique o material com base no valor obtido para o calor específico e compare o resultado com os valores de referência na Tabela~\ref{Tab:CaloresEspecificosDeReferencia}. Calcule os erros percentuais utilizando
\begin{equation}
...
\centering
	\begin{tabular}{lp{22mm}p{22mm}p{22mm}lp{22mm}p{22mm}l}
		...
		& Massas & \\
		\cmidrule{2-7}
		& $m^{\rm{Cal}}$ & $m^{\rm{Cal}}_{\text{água fria}}$ & $m^{\rm{Cal}}_{\text{água fria+quente}}$ & & $m^f$ & $m^q$ & \\
		...
		& Temperaturas \\
		\cmidrule{2-7}
		& $T_{i}$ & $T^{\textrm{água}}_{\textrm{quente}}$ & $T_{f}$ & & $T_f - T_i$ & $T_f - T_q$ \\
		\cmidrule{2-4} \cmidrule{6-7}
		& \cellcolor[gray]{0.95} & \cellcolor[gray]{0.97} & \cellcolor[gray]{0.95} & & \cellcolor[gray]{0.95} & \cellcolor[gray]{0.97} & \\
		& \cellcolor[gray]{0.89} & \cellcolor[gray]{0.92} & \cellcolor[gray]{0.89} & & \cellcolor[gray]{0.89} & \cellcolor[gray]{0.92} & \\
        & \cellcolor[gray]{0.95} & \cellcolor[gray]{0.97} & \cellcolor[gray]{0.95} & & \cellcolor[gray]{0.95} & \cellcolor[gray]{0.97} & \\
...
\centering
	\begin{tabular}{lp{22mm}p{22mm}p{22mm}lp{22mm}p{22mm}l}
		\toprule
        \multicolumn{6}{l}{\textbf{Determinação do Calor Específico (Corpo 1)}}\\
        \\
		& Massas \\
		\cmidrule{2-6}
		& $m^{\rm{Cal}}$ & $m^{\textrm{Cal + água}}_{\rm{fria}}$ & $m^{\textrm{a}}$ & & $m^f$ & \\
		...
		\bottomrule
	\end{tabular}
	\caption[][0.5cm]{Dados para o cálculo do calor específico de diferentes materiais.}
...
\centering
	\begin{tabular}{lp{22mm}p{22mm}p{22mm}lp{22mm}p{22mm}l}
		\toprule
        \multicolumn{6}{l}{\textbf{Determinação do Calor Específico (Corpo 2)}}\\
        \\
		& Massas \\
		\cmidrule{2-6}
		& $m^{\rm{Cal}}$ & $m^{\textrm{Cal + água}}_{\rm{fria}}$ & $m^{\textrm{a}}$ & & $m^f$ & \\
...
\centering
	\begin{tabular}{lp{22mm}p{22mm}p{22mm}lp{22mm}p{22mm}l}
		\toprule
        \multicolumn{6}{l}{\textbf{Determinação do Calor Específico (Corpo 3)}}\\
        \\
		& Massas \\
		\cmidrule{2-6}
		& $m^{\rm{Cal}}$ & $m^{\textrm{Cal + água}}_{\rm{fria}}$ & $m^{\textrm{a}}$ & & $m^f$ & \\
...
\centering
	\begin{tabular}{lp{22mm}p{22mm}p{22mm}lp{22mm}p{22mm}l}
		\toprule
        \multicolumn{6}{l}{\textbf{Determinação do Calor Específico (Corpo 4)}}\\
        \\
		& Massas \\
		\cmidrule{2-6}
		& $m^{\rm{Cal}}$ & $m^{\textrm{Cal + água}}_{\rm{fria}}$ & $m^{\textrm{a}}$ & & $m^f$ & \\
	...
	\end{tabular}
	\caption[][0.5cm]{Dados para o cálculo do calor específico de diferentes materiais.}
	\label{Tab:CalorEspecificoCorpo4}
\end{table*}
