...
\begin{enumerate}
	...
	\item Meça o comprimento $\ell$ do elástico e anote, juntamente com a massa total $m_t$ sustentada pelo elástico, nas colunas correspondentes ao processo de ``carga'' da Tabela~\ref{tab:ComprimentoElastico};
