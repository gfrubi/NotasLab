...
\end{align}
%
Quando se encontrarem a onda resultante será:\footnote[][2cm]{O fato de que as perturbações devido a ondas diferentes se somam é conhecido como \emph{princípio da superposição} e sua origem reside no fato de que o meio apresenta uma resposta linear a perturbações.}
\begin{align}
...
\item Afira a massa do gancho, juntamente com uma anilha e os pendure na extremidade livre da corda, fazendo-a passar pela polia e deixando o gancho suspenso;\label{Enum:itemfim}
\item Anote o valor da massa $m$ suspensa na corda na Tabela~\ref{Tab:FrequenciaFuncaoMassa}.
...
\item Varie a frequência até que uma onda estacionária com dois ventres se forme novamente, anotando os valores de distância $L$ na Tabela~\ref{Tab:FrequenciaFuncaoComprimento2}. Repita o processo até preencher a tabela ou até que as anilhas estejam prestes a tocar o chão.
