...
\begin{enumerate}
	...
	\item Ajuste o plano inclinado para um ângulo de \degree{60};
...
\begin{question}[type={exam}]{2}
Elabore em papel milimetrado um gráfico do \emph{tempo} cronometrado em função da \emph{distância} percorrida pela esfera em queda livre.\footnote{Novamente, a variável independente é o deslocamento; o tempo é a variável dependente.}
\end{question}
\vfill
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\pagebreak
...
\bottomrule
\end{tabular}
\caption[][5mm]{Valores de tempo e deslocamento para o MRU para o ângulo de \degree{30}.}
\label{DadosMRU}
\end{table*}
